...
class Object3d(object):
    ...
    def estimate_diffculty(self):
        ...
        if bb_height >= 40 and self.occlusion == 0 and self.truncation <= 0.15:
            return "Easy"
        elif bb_height >= 25 and self.occlusion in [
                0, 1
        ] and self.truncation <= 0.30:
            return "Moderate"
        elif (bb_height >= 25 and self.occlusion in [0, 1, 2]
              and self.truncation <= 0.50):
            return "Hard"
        else:
            return "Unknown"
...
MATRIX_Kt = np.array([[721.5377, 0.0, 0.0], [0.0, 721.5377, 0.0],
                      [609.5593, 172.854, 1.0]])
